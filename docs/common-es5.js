...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesTaskServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TaskService = /*#__PURE__*/function () {
      function TaskService(angularFirestore) {
        _classCallCheck(this, TaskService);

        this.angularFirestore = angularFirestore;
        this.taskCollection = this.angularFirestore.collection('tasks');
        this.tasks = this.taskCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
      ...
      _createClass(TaskService, [{
        ...
        value: function getTask(id) {
          return this.taskCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (task) {
            task.id = id;
            return task;
          }));
        }
    ...
    TaskService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    })], TaskService);
    /***/
  }
