...
/*!********************************************!*\
  !*** ./src/app/@core/data/domain/model.ts ***!
  \********************************************/
/*! exports provided: BaseEntity, Idea, Task, JobContent, Staffs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
let TaskService = class TaskService {
    constructor(angularFirestore) {
        ...
        this.taskCollection = this.angularFirestore.collection('tasks');
        this.tasks = this.taskCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
    ...
    getTask(id) {
        return this.taskCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(task => {
            task.id = id;
            return task;
        }));
    }
    addTask(task) {
        task.uid = Object(uuid__WEBPACK_IMPORTED_MODULE_4__["v4"])();
